          ...
          <form onSubmit={handleCreateNewBlog} className={cx("create-blog__form")}>
            ...
            <div className={cx("create-blog__form-block")}>
              ...
              <div className={cx("create-blog__form-group")}>
                ...
                <textarea onChange={(e) => setFormData({ ...formData, content: e.target.value })} id="contentId" className={cx("create-blog__form-textarea")} rows={7} placeholder="Write content here..." value={formData.content} />
              </div>
            </div>
